...
count = 0
void = False
while (current := source) and not void:
    if current in cave:
        break
    while True:
        if (n := add(current, (0, 1))) not in cave:
            current = n
        elif (n := add(current, (-1, 1))) not in cave:
            current = n
        elif (n := add(current, (1, 1))) not in cave:
            current = n
        else:
        ...
        if current[0] < mins[0] or current[0] > maxs[0] or current[1] > maxs[1]:
            void = True
            break
